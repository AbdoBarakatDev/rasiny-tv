    ...
    return BlocProvider(
      ...
      child: Scaffold(
        body: TvDetailContent(
          tvs: tvDetailDummy, recommendations: recommendationDummy,
...
class TvDetailContent extends StatelessWidget {
                            ...
                            Row(
                              children: [
                                Container(
                                  ...
                                  child: Text(
                                    state.tvDetails!.numberOfSeasons.toString(),
                                    // .split('-')[0],
                                ...
                                Text(
                                  _showDuration(
                                      state.tvDetails!.numberOfEpisodes),
                                  style: const TextStyle(
  ...
  Widget _showRecommendations() {
    return BlocBuilder<TvDetailsBloc, TvDetailsStates>(
      builder: (context, state) {
        switch (state.tvRecommendationsState) {
          case RequestStates.loading:
            return const Center(
              child: CircularProgressIndicator(),
            );
                      ...
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => TvDetailScreen(
                                id: state.tvRecommendations![index].id),
                          ));
                    },
                    child: FadeInUp(
                      from: 20,
